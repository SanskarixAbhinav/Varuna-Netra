...
export const DrawAoi = ({ active, onDone, onCancel }) => {
  ...
  return <Polygon positions={pts} pathOptions={{ color: "#9D4EDD", weight: 2, dashArray: "6,4", fillOpacity: 0.12 }} />;
};

export const DrawHint = ({ active, count }) => active ? (
  <div className="absolute bottom-3 left-1/2 z-[1000] -translate-x-1/2 rounded px-3 py-1.5 font-mono text-[11px] text-slate-100" style={{ background: "rgba(157,78,221,0.85)" }} data-testid="draw-aoi-hint">
