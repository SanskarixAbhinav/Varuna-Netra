...
export const TYPE_COLOR = { territorial: "#FF6B00", contiguous: "#FFB703", eez: "#38BDF8", port_state: "#10B981", custom: "#9D4EDD" };
...
export const PROV_COLOR = { AUTHORITATIVE: "#10B981", REFERENCE: "#38BDF8", DEMO: "#FFB703", "USER-DEFINED": "#9D4EDD", PRESET: "#F8FAFC", UNVERIFIED: "#94A3B8" };

export const zoneStyle = (ft, selected) => ({ color: TYPE_COLOR[ft.properties.zone_type] || "#94A3B8", weight: selected === ft.properties.code ? 3 : ft.properties.zone_type === "territorial" ? 2 : 1.5, fillOpacity: selected === ft.properties.code ? 0.28 : 0.13, dashArray: TYPE_DASH[ft.properties.zone_type] ?? null });
