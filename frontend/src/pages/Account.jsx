...
const STATUS_COLOR = { pending: "#FFB703", approved: "#10B981", rejected: "#FF2A6D", cancelled: "#94A3B8" };
      ...
      <div className="grid gap-4 max-w-3xl">
        <div className="panel p-5 fade-up" data-testid="account-summary">
          {isGuest ? (
            <div>
              ...
              <p className="mt-1 font-display text-xl font-bold" style={{ color: "#94A3B8" }}>Guest · read only</p>
            ...
            <div>
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div><p className="label-mono">Current role</p><p className="mt-1 font-mono text-sm font-semibold uppercase" style={{ color: "#00F0FF" }} data-testid="account-role">{ROLE_LABEL[user?.role] || user?.role}</p></div>
        ...
        {canRequest && (!req || req.status !== "pending") && (
          <div className="panel p-5 fade-up" data-testid="role-request-form">
            <div className="mb-3 flex items-center gap-2"><ArrowUpCircle size={16} color="#00F0FF" /><h2 className="font-display text-lg font-semibold">Request elevated access</h2></div>
        ...
        {canRequest && req && req.status === "pending" && (
          <div className="panel p-5 fade-up" data-testid="role-request-pending">
            <p className="text-sm text-slate-300">Your request for <span className="font-mono uppercase" style={{ color: "#FFB703" }}>{req.requested_role}</span> access is pending administrator approval.</p>
